...
<head>
    ...
    <script>
        function test(ejemplo) {
            ...
            document.getElementById("result").innerHTML = "<iframe name='truncframe' id='truncframe' width='100%' height='400px' src='http://"+url+ejemplo+"?url_="+url+"' frameborder='0' marginwidth='0' marginheight='0' allowtransparency='true' align='center'></iframe>";
        }
    </script>
    <style>
        .link {
    ...
    <table style="width: 70%;margin: auto;">
        ...
        <tr>
            <td style="border-bottom: 1px solid black;">
                ...
                http://<input type="text" id="url" style="width: 250px" value="<?= $_SERVER['SERVER_NAME'].str_replace('index.php', '', $_SERVER['REQUEST_URI'])?>">
            </td>
        </tr>
        <tr>
            <td class="link">
